...
static DECLARE_MUTEX(ButtonLock);			//define mutex
...
{
	//get sem
	down(&ButtonLock); //if there is ButtonLock when the next app runs, it will sleep at here until the ButtonLock release.
