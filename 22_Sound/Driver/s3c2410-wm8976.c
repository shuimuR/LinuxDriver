...
static void wm8976_write_reg(unsigned char Addr, unsigned int Value)
{
	int i;
	unsigned long flags;
	unsigned short WriteData;

	WriteData = (Addr << 9) | Value & 0x1FF;
...
static void init_wm8976(void)
{
	...
	/* OUT2\B5\C4\D7\F3/\D3\D2\C9\F9\B5\C0\B4\F2\BF\AA
	 * \D7\F3/\D3\D2ͨ\B5\C0\CA\E4\B3\F6\BB\EC\D2\F4\B4\F2\BF\AA
	 * \D7\F3/\D3\D2DAC\B4\F2\BF\AA
	 */
